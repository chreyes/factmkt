class FacturasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @factura.save
        format.html { redirect_to facturas_url, notice: 'Factura was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @factura.update(factura_params)
        format.html { redirect_to facturas_url, notice: 'Factura was successfully updated.' }
  ...
  private
    ...
    def factura_params
      params.require(:factura).permit(:fecha, :numero, :cliente_id, items_attributes: [:id, :cantidad, :detalle, :precio, :_destroy])
    end
end
